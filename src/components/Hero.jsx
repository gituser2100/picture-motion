  ...
  <div class="bg-gradient-to-b from-violet-600/[.15] via-transparent">
    <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-24 space-y-8">
      ...
      <div class="max-w-3xl text-center mx-auto">
        <h1 class="block font-medium text-transparent bg-clip-text bg-gradient-to-r from-purple-200 to-purple-500 text-4xl sm:text-5xl md:text-6xl lg:text-7xl">
          PictureMotion
        </h1>
      </div>
      {/* <!-- End Title --> */}
      ...
      <div class="max-w-3xl text-center mx-auto">
        <p class="text-lg text-gray-400">Your all-in-one entertainment platform</p>
      </div>
